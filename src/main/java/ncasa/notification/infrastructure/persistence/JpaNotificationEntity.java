...
class JpaNotificationEntity {
    ...
    @Column(name="household_id",nullable=false)UUID householdId;@Column(name="plan_id")UUID planId;@Column(name="calendar_entry_id")UUID calendarEntryId;
    @Column(nullable=false,length=80)String kind;@Column(nullable=false,length=240)String subject;
    @Column(precision=19,scale=4)BigDecimal amount;@Column(length=3)String currency;
    @Column(name="occurrence_date",nullable=false)LocalDate occurrenceDate;@Column(name="occurrence_number")Integer occurrenceNumber;
    @Column(name="total_occurrences")Integer totalOccurrences;@Column(name="attention_reason",length=500)String attentionReason;
    @Column(name="completed_by_member_id")UUID completedByMemberId;
